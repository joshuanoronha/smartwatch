...
void loop() {
  ...
  Serial.println(get_path(project_id, location, registry_id, device_id).c_str() );
  delay(2000);
  Serial.println("=============Doing Telemetry");
  pushTelemetryEvent();
  Serial.println("=============Telemetry Done");
  getConfig();
}
